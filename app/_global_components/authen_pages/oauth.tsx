    ...
    return (
        <div className="w-full mt-6 mb-4">
            ...
            <button
                ...
                className="flex items-center justify-center w-full py-2.5 px-4 cursor-pointer bg-transparent border border-gray-500 rounded-md hover:bg-gray-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                {isLoading ? (
                ...
                <span className="text-white text-[1em] font-semibold">
